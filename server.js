...
if(option === 'createRef'){
  try {
    ...
    app.locals.refList =''
    let formattedSreData = addLineBreaks(sre.data);
    res.render('home', { output:o, literature: l, plgRes:'', ref: formattedSreData,lr_ct:''})
  } catch (err) {
    console.error(err)
  }
} else {
...
app.post('/create',async(req,res)=>{
  ...
  if(option === 'createliter'){
    try {
      ...
      app.locals.refList =''
      let formattedSreData = addLineBreaks(sre.data);
      res.render('home', { output:o, literature: l, plgRes:'',ref:'',lr_ct:formattedSreData})
    } catch (err) {
      console.error(err)
    }
  } else {
